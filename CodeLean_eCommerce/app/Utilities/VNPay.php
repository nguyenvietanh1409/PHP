...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "XDYC3G1B"; //Mã website tại VNPAY
    static $vnp_HashSecret = "YRGQRTKIHIBSSTWSLUEXUJYTVMYGTEKL"; //Chuỗi bí mật
    static $vnp_Url = "https://sandbox.vnpayment.vn/merchantv2/";
...
//        $vnp_BankCode = 'NCB';
        ...
        $inputData = array(
            ...
            "vnp_ReturnUrl" => VNPay . phpenv('APP_URL'),
