    ...
    <div class="nav-item">
        <div class="container">
            ...
            <div class="nav-menu mobile-menu">
                <ul>
                    <li class="{{ (request()->segment(1)=='') ? 'active' : '' }}"><a href="./index">Home</a></li>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>A1 Yet Kieu Ha Noi</li>
                        <li>Phone: 0325174809</li>
                        <li>Email: vietanh20030914@gmail.com</li>
                    </ul>
